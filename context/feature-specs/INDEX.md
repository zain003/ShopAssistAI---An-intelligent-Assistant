...
| **`FEAT-002-BE`** | Backend | P0 | Conversation Manager & Prompt Orchestrator| `000-shared-contracts` | 130 | ☐ Not Started | `feature-test-reports/FEAT-002-test-report.md` |
| **`FEAT-002-VERIFY`** | Verify | P0 | Verification Pass: Dialogue & Memory | `FEAT-002-BE` | 75 | ☐ Not Started | `feature-test-reports/FEAT-002-test-report.md` |
